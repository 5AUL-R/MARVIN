...
## Background
Yesterday roved much more problematic than expected (although in hindsight I can't believe I expected working with an old NUC would be straightforward.  
...
Now these issues are probalby somewhat fixable, the issue is that this is turning into a hydra of issue - cut the head of one, two more take it's place.  
...
I decided to cut my losses trying to upgrade the safe way that changes as little things as possible, because it simply will not work, it will be sandwhiching band aids on what seems to be quite structural issues.  
